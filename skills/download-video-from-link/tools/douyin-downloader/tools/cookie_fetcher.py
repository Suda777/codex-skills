...
async def capture_cookies(args: argparse.Namespace) -> int:
    ...
    async with async_playwright() as p:
        ...
        # Reuse the locally installed Google Chrome instead of downloading a
        # second Chromium bundle into a global Playwright cache directory.
        if args.browser == "chromium":
            launch_options["channel"] = "chrome"
        browser = await browser_factory.launch(**launch_options)
